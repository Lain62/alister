...
require_relative "lib/alister/version"

Gem::Specification.new do |spec|
  spec.name = "alister"
  spec.version = Alister::VERSION
  spec.authors = ["Lain Madeline"]
  spec.email = ["laimadelain@gmail.com"]
  ...
  spec.files = IO.popen(%w[git ls-files -z], chdir: __dir__, err: IO::NULL) do |ls|
    ls.readlines("\x0", chomp: true).reject do |f|
      (f == gemspec) ||
        ...
        f == "lib/html/generate_yard_tags.rb"
    end
  end
  spec.bindir = "exe"
